...
export type TurnstileApi = {
  ...
  /** Throws the solved token away and asks the visitor again */
 ...
 * cannot be reached — offline, or refused by a content blocker. The form then
 * says so instead of waiting on a widget that will never arrive, since sending
 * it without a token would only be refused.
 */
